...
public:
	L3NeighborCellsDescription() : L3FrequencyList(gConfig.getVector("GSM.CellSelection.Neighbors")) {}
...
public:
	...
	L3NCCPermitted() : L3ProtocolElement() { mPermitted = gConfig.getNum("GSM.CellSelection.NCCsPermitted"); }
...
public:
	L3DedicatedModeOrTBF() : L3ProtocolElement(), mDownlink(0), mTMA(0), mDMOrTBF(0) {}
...
public:
	...
	L3RRCause(int wValue = 0) : L3ProtocolElement() { mCauseValue = wValue; }
...
public:
	enum Mode { SignallingOnly = 0, SpeechV1 = 1, SpeechV2 = 2, SpeechV3 = 3 };
...
public:
	L3MeasurementResults() : L3ProtocolElement(), mMEAS_VALID(false), mNO_NCELL(0) {}
	...
	unsigned RXLEV_NCELL(unsigned i) const
	{
		assert(i < mNO_NCELL);
