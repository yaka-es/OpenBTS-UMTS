...
public:
	L3LocationUpdatingAccept(const L3LocationAreaIdentity &wLAI)
		: L3MMMessage(), mLAI(wLAI), mHaveMobileIdentity(false)
	{
	}

	L3LocationUpdatingAccept(const L3LocationAreaIdentity &wLAI, const L3MobileIdentity &wMobileIdentity)
		: L3MMMessage(), mLAI(wLAI), mHaveMobileIdentity(true), mMobileIdentity(wMobileIdentity)
	{
	}
...
public:
	L3LocationUpdatingReject(const L3RejectCause &cause) : L3MMMessage(), mRejectCause(cause) {}
...
public:
	L3CMServiceReject(const L3RejectCause &wCause) : L3MMMessage(), mCause(wCause) {}
