...
public:
	L3SystemInformationType3() : L3RRMessageRO(), mHaveRestOctets(gConfig.defines("GSM.SI3RO")) {}
...
public:
	L3ImmediateAssignment(const L3RequestReference &wRequestReference,
		...
		: L3RRMessageNRO(), mRequestReference(wRequestReference), mChannelDescription(wChannelDescription),
...
public:
	...
	L3ChannelRelease(const L3RRCause &cause = L3RRCause(0x0)) : L3RRMessageNRO(), mRRCause(cause) {}
...
public:
	...
	L3ApplicationInformation(BitVector &data, unsigned protocolIdentifier = 0, unsigned cr = 0,
