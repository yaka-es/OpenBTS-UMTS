...
signalVector *generateUMTSPulse(int symbolLength, int samplesPerSymbol)
{
...
bool generateMidamble(signalVector &gsmPulse, int samplesPerSymbol, int TSC)
{
	...
	*(emptyPulse.begin()) = 1.0;
	...
	signalVector *middleMidamble =
		modulateBurst(gTrainingSequence[TSC].segment(5, 16), emptyPulse, 0, samplesPerSymbol);
	signalVector *midamble = modulateBurst(gTrainingSequence[TSC], gsmPulse, 0, samplesPerSymbol);
