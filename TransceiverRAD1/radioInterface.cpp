...
RadioInterface::RadioInterface(
	RadioDevice *wRadio, int wReceiveOffset, int wRadioOversampling, bool wLoadTest, UMTS::Time wStartTime)
...
#define FILTLEN 17
	...
	float invFilt[] = {0.010688, -0.021274, 0.040037, -0.06247, 0.10352, -0.15486, 0.23984, -0.42166, 0.97118,
		-0.42166, 0.23984, -0.15486, 0.10352, -0.06247, 0.040037, -0.021274, 0.010688};
	float invFiltRcv[] = {-3.7048e-03, -1.8549e-04, 8.5879e-03, -2.1284e-02, 3.8077e-02, -5.8165e-02, 8.5446e-02,
		-1.5441e-01, 1.0650, -1.5441e-01, 8.5446e-02, -5.8165e-02, 3.8077e-02, -2.1284e-02, 8.5879e-03,
		-1.8549e-04, -3.7048e-03};
...
void RadioInterface::driveReceiveRadio(int guardPeriod)
{
	...
	while (rcvSz > vecSz) {
		...
		rxDataVector.segmentCopyTo(
			*rxHistoryVector, symbolsPerSlot * samplesPerSymbol - (FILTLEN - 1), FILTLEN - 1);
	}
