...
void LogicalChannel::setPhy(float wRSSI, float wTimingError) { mUep->setPhy(wRSSI, wTimingError); }
...
void LogicalChannel::send(const GSM::Primitive &prim, unsigned SAPI) { send(GSM::L3Frame(prim), SAPI); }
