...
public:
	Parity(uint64_t wCoefficients, unsigned wParitySize, unsigned wCodewordSize)
		: ParityGenerator64(wCoefficients, wParitySize), mCodewordSize(wCodewordSize)
	{
	}
...
public:
	...
	//@{
	BitVector(char *wData, char *wStart, char *wEnd) : Vector<char>(wData, wStart, wEnd) { BVDEBUG("bvc1\n"); }
	...
	const BitVector alias() const { return segment(0, size()); }
...
public:
	...
	*/
	...
	const SoftVector alias() const { return segment(0, size()); }
