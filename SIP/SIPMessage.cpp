...
osip_message_t *SIP::sip_register(const char *sip_username, short timeout, short wlocal_port, const char *local_ip,
	const char *proxy_ip, const char *from_tag, const char *via_branch, const char *call_id, int cseq, string *RAND,
	const char *IMSI, const char *SRES)
{
...
osip_message_t *SIP::sip_message(const char *dialed_number, const char *sip_username, short wlocal_port,
	const char *local_ip, const char *proxy_ip, const char *from_tag, const char *via_branch, const char *call_id,
	int cseq, const char *message, const char *content_type)
{
...
osip_message_t *SIP::sip_invite5031(short rtp_port, const char *sip_username, short wlocal_port, const char *local_ip,
	...
	unsigned codec)
{
	...
	sdp_message_o_origin_set(
		sdp, strdup(sip_username), strdup("0"), strdup("0"), strdup("IN"), strdup("IP4"), strdup(local_ip));

	sdp_message_s_name_set(sdp, strdup("Talk Time"));
	sdp_message_t_time_descr_add(sdp, strdup("0"), strdup("0"));

	sprintf(temp_buf, "%i", rtp_port);
	sdp_message_m_media_add(sdp, strdup("audio"), strdup(temp_buf), NULL, strdup("RTP/AVP"));
	sdp_message_c_connection_add(sdp, 0, strdup("IN"), strdup("IP4"), strdup(local_ip), NULL, NULL);
...
osip_message_t *SIP::sip_invite(const char *dialed_number, short rtp_port, const char *sip_username, short wlocal_port,
	const char *local_ip, const char *proxy_ip, const char *from_tag, const char *via_branch, const char *call_id,
	int cseq, unsigned codec)
{
...
osip_message_t *SIP::sip_ack(const char *req_uri, const char *dialed_number, const char *sip_username,
	short wlocal_port, const char *local_ip, const char *proxy_ip, const osip_from_t *from_header,
	const osip_to_t *to_header, const char *via_branch, const osip_call_id_t *call_id_header, int cseq)
{
...
osip_message_t *SIP::sip_bye(const char *req_uri, const char *dialed_number, const char *sip_username,
	short wlocal_port, const char *local_ip, const char *proxy_ip __attribute_used__, short wproxy_port,
	const osip_from_t *from_header, const osip_to_t *to_header, const char *via_branch,
...
osip_message_t *SIP::sip_okay(osip_message_t *inv, const char *sip_username, const char *local_ip, short wlocal_port,
	short rtp_port, unsigned audio_codec)
{
...
osip_message_t *SIP::sip_okay_SMS(osip_message_t *inv, const char *sip_username __attribute_used__,
	const char *local_ip __attribute_used__, short wlocal_port __attribute_used__)
{
...
osip_message_t *SIP::sip_info(unsigned info, const char *dialed_number, short rtp_port __attribute_used__,
	const char *sip_username, short wlocal_port, const char *local_ip, const char *proxy_ip, const char *from_tag,
