...
public:
	...
	*/
	virtual int readSamples(
		short *buf, int len, bool *overrun, long long timestamp, bool *underrun, unsigned *RSSI = NULL) = 0;
	/**
	...
	*/
	virtual int writeSamples(short *buf, int len, bool *underrun, long long timestamp) = 0;
