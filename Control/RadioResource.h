...
public:
	ChannelRequestRecord(unsigned wRA, const UMTS::Time &wFrame, float wRSSI, float wTimingError)
...
public:
	...
	*/
	PagingEntry(
		const GSM::L3MobileIdentity &wID, UMTS::ChannelTypeL3 wType, unsigned wTransactionID, unsigned wLife)
...
public:
	...
	*/
	void addID(const GSM::L3MobileIdentity &addID, UMTS::ChannelTypeL3 chanType,
		Control::TransactionEntry &transaction, unsigned wLife = gConfig.getNum("SIP.Timer.B"));
